        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:block text-left">
              <p className="text-sm font-bold text-slate-800 leading-none">Nguyễn Văn A</p>
            ...
            {showProfileMenu && (
              ...
              >
                <div className="px-4 py-2 border-b border-slate-100">
                  ...
                  <p className="text-sm text-slate-600 truncate">nguyenvana@example.com</p>
                </div>
                ...
                <button className="w-full flex items-center px-4 py-2.5 text-sm text-red-600 hover:bg-red-50">
